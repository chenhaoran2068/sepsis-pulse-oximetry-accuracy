# Synthetic-demo extraction of non-I/O RF functions from the hash-pinned formal core.
# Original source lines 1-5 and 79-350; protected-file and private-output helpers are omitted.
